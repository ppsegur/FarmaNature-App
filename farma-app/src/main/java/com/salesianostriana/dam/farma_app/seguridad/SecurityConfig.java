    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authz -> authz
               ...
               .requestMatchers(HttpMethod.GET,"/comentario/**").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/carrito/all").permitAll()
                .requestMatchers(HttpMethod.GET, "/carrito/ventas-por-dia").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/citas/solicitar").permitAll()
                ...
                .requestMatchers(HttpMethod.GET,"/citas/cliente/**").permitAll()
